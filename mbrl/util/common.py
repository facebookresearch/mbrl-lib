...
def create_replay_buffers(
    ...
    The configuration should be structured as follows::
        ...
        -cfg
          ...
          -algorithm
            ...
            -bootstrap_permutes (bool, optional): whether the bootstrap datasets in the buffer
                are generated by permuting the stored data or by sampling from it
    ...
    if train_is_bootstrap:
        train_buffer = mbrl.replay_buffer.BootstrapReplayBuffer(
            ...
            bootstrap_permutes=cfg.algorithm.get("bootstrap_permutes", True),
        )
    else:
        train_buffer = mbrl.replay_buffer.IterableReplayBuffer(
            dataset_size,
