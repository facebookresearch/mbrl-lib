...
@dataclass
class TrajTransitionBatch:
    """Represents a batch of transitions"""

    obs: Optional[TensorType]
    act: Optional[TensorType]
    next_obs: Optional[TensorType]
    horizon: Optional[TensorType]
    rewards: Optional[TensorType]
    dones: Optional[TensorType]
    ...
    def astuple(self) -> Transition:
        return self.obs, self.act, self.next_obs, self.horizon, self.rewards, self.dones
...
ModelInput = Union[torch.Tensor, TransitionBatch, TrajTransitionBatch]
